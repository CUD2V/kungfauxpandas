...
\begin{table}
	\caption{Kung Faux Pandas data synthesis plugin timings (seconds)}
	...
	\begin{tabular}{l c c c c c}
		...
		\midrule 
		Trivial & 2.5e-06 & 2.25e-06 & 2.27e-06 & 2.23e-06 & 2.16e06 \\ 
		KDE & x.y (1.04) &  & x.y (1.04) &  &  \\ 
		DS Correlated & x.y (1.04) &  &  & x.y (1.04) &  \\ 
		DS Correlated w/Config & x.y (1.04) &  &  &  & x.y (1.04) \\ 
		DS Independent & x.y (1.04) &  &  &  &  \\ 
		DS Independent w/Config & x.y (1.04) &  &  &  & x.y (1.04) \\
		\midrule
	\end{tabular}
\end{table}

hmm, that's interesting. Describe what this means...
