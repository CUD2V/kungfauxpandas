...
\section{Experiments}
Tested this on a Ubuntu 16.04 Linux virtual machine running on Virtual Box with 12 CPUs and 64GB of RAM allocated from the host system.

Running the query shown in the UI screenshot 

rows: query time: method: fauxify time:
1k
10k
100k
1000k

Data from notebook performance\_tests.ipynb

\begin{table}
  \caption{Kung Faux Pandas data synthesis method timings}
