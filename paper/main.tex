...
% why not full synthesize a full dataset? limited to sql query where relevant data is brought together, easier to model 1 table than lots of separate tables. Modelling lots of separate tables requires extensive meta data configuration and a significant amount of computing power to generate...
